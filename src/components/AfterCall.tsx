      ...
      <div className="px-4 lg:px-6 py-3 bg-white border-b border-gray-100 flex flex-wrap items-center justify-between gap-2 shrink-0">
        <div className="flex items-center gap-3">
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-lime-50 text-direct-800 font-bold text-sm">
            ...
            Po hovoru —{' '}
            <InfoTooltip content={glossary.ACW}>
              <span className="cursor-help border-b border-dotted border-direct-600/40">ACW</span>
            </InfoTooltip>
          </span>
          <div>
        ...
        <div className="bg-white rounded-2xl shadow-card flex flex-col lg:overflow-hidden">
          <div className="px-5 py-3.5 bg-blue-50 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2">
              ...
              <InfoTooltip content={glossary.AI}>
                <span className="px-2 py-0.5 rounded-full bg-blue-100 text-blue-600 text-[10px] font-semibold cursor-help">AI</span>
              </InfoTooltip>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="bg-white rounded-2xl shadow-card flex flex-col lg:overflow-hidden">
          <div className="px-5 py-3.5 bg-direct-25 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-direct-800">
                Záznam z jednání (
                <InfoTooltip content={glossary.ZZJ}>
                  <span className="cursor-help border-b border-dotted border-direct-600/40">ZZJ</span>
                </InfoTooltip>
                )
              </h3>
              <InfoTooltip content={glossary.AI}>
                <span className="px-2 py-0.5 rounded-full bg-direct-50 text-direct-600 text-[10px] font-semibold cursor-help">AI</span>
              </InfoTooltip>
            </div>
            <FeedbackBtns />
          </div>
